...
return {
    Particles = {
        ...
        StarSparkles = FireworkAssetsUtility.CreateParticle({
            Name = "StarSparkles",
            Color = ColorSequence.new(Color3.new(1, 1, 1)),
            Brightness = 5,
            LightEmission = 5,
            ...
            Size = NumberSequence.new(20),
            Transparency = NumberSequence.new({
                NumberSequenceKeypoint.new(0, 1),
                NumberSequenceKeypoint.new(0.0368, 0),
                NumberSequenceKeypoint.new(1, 1),
            }),
            Enabled = false,
            Lifetime = NumberRange.new(0.1, 0.6),
            Rate = 2000,
            Rotation = NumberRange.new(-360, 360),
            RotSpeed = NumberRange.new(-5000, 5000),
            Speed = NumberRange.new(0, 50000),
            SpreadAngle = Vector2.new(-360, 360),
            Shape = Enum.ParticleEmitterShape.Sphere,
            ShapePartial = 1,
            Acceleration = Vector3.new(0, 0, 0),
